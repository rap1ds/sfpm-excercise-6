...
Ericsson toteutti muutoksen ketteriin menetelmiin mielestäni todella hienosti. Artikkeleissa, joissa kerrotaan Ericssonin muutoksesta \citep{mikkonen2011} \citep{hallikainen2012} pääosin kuvaillaan muutoksen onnistumisesta eikä juurikaan mainita, että muutoksesta olisi seurannut juuri mitään huonoa. Artikkelien perusteella voin todeta, että olisin itse toiminut varmasti samoin kuin Ericsson. Täten tehtävänannossa pyydettyä kriittistä näkökulmaa esseeseen oli hieman hankala näiden artikkelien pohjalta löytää.
